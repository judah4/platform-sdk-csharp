...
namespace Improbable.SpatialOS.ServiceAccount.V1Alpha1
{
    ...
    public sealed partial class ServiceAccountServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </remarks>
        public gaxgrpc::CallSettings ListServiceAccountsSettings { get; set; } = gaxgrpc::CallSettings.FromRetry(
        ...
        /// Default RPC expiration is 600000 milliseconds.
        /// </remarks>
        public gaxgrpc::CallSettings CreateServiceAccountSettings { get; set; } = gaxgrpc::CallSettings.FromRetry(
            gaxgrpc::RetrySettings.FromExponentialBackoff(
                maxAttempts: _maxAttempts,
                initialBackoff: sys::TimeSpan.FromMilliseconds(50),
                maxBackoff: sys::TimeSpan.FromMilliseconds(600000),
        ...
        /// Default RPC expiration is 600000 milliseconds.
        /// </remarks>
        public gaxgrpc::CallSettings UpdateServiceAccountSettings { get; set; } = gaxgrpc::CallSettings.FromRetry(
            gaxgrpc::RetrySettings.FromExponentialBackoff(
                maxAttempts: _maxAttempts,
                initialBackoff: sys::TimeSpan.FromMilliseconds(50),
                maxBackoff: sys::TimeSpan.FromMilliseconds(600000),
        ...
        /// Default RPC expiration is 600000 milliseconds.
        /// </remarks>
        public gaxgrpc::CallSettings DeleteServiceAccountSettings { get; set; } = gaxgrpc::CallSettings.FromRetry(
            gaxgrpc::RetrySettings.FromExponentialBackoff(
                maxAttempts: _maxAttempts,
                initialBackoff: sys::TimeSpan.FromMilliseconds(50),
                maxBackoff: sys::TimeSpan.FromMilliseconds(600000),
